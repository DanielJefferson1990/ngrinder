<template>
    <div v-show="dataLoadFinished" class="report-container">
        <div class="row">
            <div class="span4 intro" data-step="4" :data-intro="i18n('intro.report.summary')">
                <fieldset>
            ...
            <div class="span8 intro" data-step="5" :data-intro="i18n('intro.report.tpsGraph')">
                <fieldSet>
                    <legend>
                        ...
                        <a id="detail_report_btn" @click="detailReport" class="btn btn-primary pull-right" v-text="i18n('perfTest.report.detailedReport')"></a>
                    </legend>
                </fieldSet>
            ...
            <div class="span4">
                <fieldSet>
                    <legend>
                        ...
                        <span class="logs-help-popover"
                              rel="popover" id="log_comment"
                              data-html="true"
            ...
            <div class="span8 intro commend-container" data-step="6" :data-intro="i18n('intro.report.testComment')">
                <fieldSet>
                    <legend>
                        ...
                        <a id="leave_comment_btn" @click="leaveComment" class="btn btn-primary pull-right" v-text="i18n('perfTest.report.leaveComment')"></a>
                    </legend>
                </fieldSet>
        ...
        created() {
            this.$http.get(`/perftest/api/${this.$route.params.id}/basic_report?imgWidth=600`)
                .then(res => {
                    ...
                    this.report.test = res.data.test;
